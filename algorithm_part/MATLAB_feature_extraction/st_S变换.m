...
function [st1,t,f] = st(timeseries,minfreq,maxfreq,samplingrate,freqsamplingrate);
...
st1 = strans(timeseries,minfreq,maxfreq,samplingrate,freqsamplingrate,verbose,removeedge,analytic_signal,factor); 
